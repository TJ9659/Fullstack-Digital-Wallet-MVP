...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleInvalidAmount(InvalidAmountException exception) {
        ProblemDetail errorDetail = ProblemDetail.forStatusAndDetail(HttpStatusCode.valueOf(400), exception.getMessage());
        errorDetail.setProperty("field", "amount");
        return errorDetail;
    }
    ...
    public ProblemDetail handleSecurityException(Exception exception) {
        ...
        if(exception instanceof AccountNotFoundException){
            ...
            errorDetail.setProperty("description", "The requested account does not exist in our system.");
        }
